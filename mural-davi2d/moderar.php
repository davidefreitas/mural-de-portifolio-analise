...
<div style="margin: 20px 0; text-align: center;">
    <a href="index.php" class="btn">Voltar para o Formulário</a>
</div>
...
if(mysqli_num_rows($seleciona) <= 0){
    ...
    while($res = mysqli_fetch_assoc($seleciona)){
        ...
        echo "<li><strong>ID:</strong> {$res['id']} 
              <a href='moderar.php?acao=editar&id={$res['id']}' class='btn'>Editar</a>
              <a href='moderar.php?acao=excluir&id={$res['id']}' class='btn-excluir' onclick=\"return confirm('Tem certeza que deseja excluir este pedido?');\">Excluir</a>
              </li>";
